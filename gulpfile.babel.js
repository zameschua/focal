...
import mainWebpackConfig from './main/webpack.config';
...
gulp.task('main-html', ['clean'], () => {
  return gulp.src('main/src/index.html')
    .pipe(plugins.rename('main.html'))
    .pipe(gulp.dest('./build'))
});
...
gulp.task('build', ['copy-icon', 'copy-manifest', 'event-js', 'content-js', 'main-js', 'main-html', 'popup-js', 'popup-html']);
